...
return [
	...
	"im_add_friend" => "CREATE TABLE im_add_friend(
		...
		`uid` int(11) not null COMMENT '发起用户ID',
		
		`to_uid` int(11) not null COMMENT '添加用户ID',
		...
		`addtime` int(11) not null default 0 COMMENT '发起时间',
		
		`uptime` int(11) not null default 0 COMMENT '同意时间',
	...
	"im_friend" => "CREATE TABLE im_friend (
		...
		`friend_id` int(11) not null COMMENT '好友ID(外键)',
		
		`class_id` int(11) not null default 0 COMMENT '用户分组ID',
	...
	`uid` INT(11) NOT NULL COMMENT '发送用户ID(外键)',
	
	`to_uid` INT(11) NOT NULL COMMENT '接受用户ID(外键)',
	...
	`addtime` int(11) NOT NULL DEFAULT 0 COMMENT '消息发送时间',
	...
	"im_group" => "CREATE TABLE im_group (
		...
		`add_uid` int(11) not null COMMENT '创建人ID(外键)',
	...
	"im_group_user" => "CREATE TABLE im_group_user (
		...
		`group_id` int(10) not null COMMENT '群组ID(外键)',
		
		`addtime` int(11) not null default 0 COMMENT '入群时间',
	...
	"im_group_message" => "CREATE TABLE im_group_message(
		...
		`id` int(11) not null AUTO_INCREMENT comment '群消息ID(主键)',
		...
		`addtime` int(11) NOT NULL DEFAULT 0 COMMENT '信息创建时间',
	...
	"im_group_message_user" => "CREATE TABLE im_group_message_user(
		...
		`uid` int(11) not null COMMENT '接受用户ID(外键)',
		
		`group_id` int(11) not null COMMENT '群组ID(外键)',
	...
	"im_group_message_touser" => "CREATE TABLE im_group_message_touser(
		...
		`uid` int(11) not null COMMENT '发送者ID(外键)',
